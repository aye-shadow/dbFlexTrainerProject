...
namespace WindowsFormsApp1
{
    public partial class Manage_member : Form
    {
        ...
        public Manage_member(string gym)
        {
            InitializeComponent();
            gymName = gym;
        ...
        {
            ownerRemoveMemberAccounts ownerManageMemberAccounts = new ownerRemoveMemberAccounts(gymName);
            this.Hide();
        ...
        {
            ownerViewAllMembers ownerViewAllMembers = new ownerViewAllMembers(gymName);
            this.Hide();
        ...
        {
            db_project_bois.ownerHome ownerHome = new db_project_bois.ownerHome();
            this.Close();
            ownerHome.Show();
        }
